...
const SectionBannerText = () => {
  return (
    <div className=' z-10 space-y-5 rounded-lg border-2 border-sky-200 p-20 text-sky-200 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f]'>
